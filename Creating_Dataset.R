...
data_wide$tert_share <- old_data$Tert_share[matches_risk]
data_wide$tertII_share <- old_data$Tert_sekun_share[matches_risk]
...
data_wide$tert_share[is.na(data_wide$tert_share)] <- old_data$Tert_share[matches_municipality]
data_wide$tertII_share[is.na(data_wide$tertII_share)] <- old_data$Tert_sekun_share[matches_municipality]
...
data_wide$tert_share[is.na(data_wide$tert_share)] <- old_data$Tert_share[matches_municipality2]
data_wide$tertII_share[is.na(data_wide$tertII_share)] <- old_data$Tert_sekun_share[matches_municipality2]
...
data_wide$disaster_treat_daycount[is.na(data_wide$disaster_treat_daycount)]
...
delete_columns <- c("composite_key", "composite_key2", "composite_key3", 
                    ...
                    "edu_female_tert", "age_total", "0-17", "18-30",
                    "31-45", "46-65", "66-85", "86-100")
...
data_wide[, !names(data_wide) 
          %in% non_numeric_cols] <- lapply(data_wide[, !names(data_wide) 
                                                     %in% non_numeric_cols], as.numeric)
