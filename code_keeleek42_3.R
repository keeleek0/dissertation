...
#       Part 3 - the new variables 2018 - 2024
...
sink("Replication of Tables C.txt")
print("######")
print("######")
...
sink("Replication of Tables C.txt", append = TRUE)
print("######")
print("######")
...
mod_3.3.3 <- lm(yes_p_per ~ treated + p_edu_null + 
                  p_edu_matura + p_edu_tert +
                  GPS_vshare + SPS_vshare + CVP_vshare + 
                  FDP_vshare + SVP_vshare + rainfall_1000 + vlose.sh + wasser.sh + 
                  gras.sh + kuenst.sh +
